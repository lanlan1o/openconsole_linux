...
#error "Vectorizing this function improves overall performance by up to 40%. Don't remove this warning, just add the vectorized code."
    ...
    {
        // Linux port: wchar_t is 4 bytes wide here, but the SIMD paths above
        // assume a 2-byte wchar_t (they write uint16_t whitespace patterns into
        // the wchar_t buffer, producing invalid codepoints like 0x00200020).
        // Fall back to a portable fill.
